...
J_vals_test1 = np.array([J_coupling_testing2(l_c_val, l_Gf, l_Gn, l_Rf, l_Rn, cap.get_Lm(10e-6), cap.get_Cm(10e-6), phase_vel=phase_vel, Z0=Z0) for l_c_val in l_c_vals])
...
plt.plot(l_c_vals, J_vals_test1/(2*np.pi * 1e6))
